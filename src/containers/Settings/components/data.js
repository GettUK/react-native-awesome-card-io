...
const privacy = [
  ...
  { type: 'subheader', value: '1. GETT PRIVACY POLICY' },
  {
    type: 'list',
    value: [
      { type: 'plain', marker: '1.1', value: 'Gett (“Gett”, “we”, “our”, and/or “us”) is a company committed to protecting and respecting your privacy, as user or person contacting, visiting, or otherwise submitting information to Gett.' },
      { type: 'plain', marker: '1.2', value: 'Safeguarding your Personal Information is important to Gett and it recognises the responsibility you entrust it when providing your Personal Information. This Privacy and Cookie Policy (“Privacy Policy”) details how your Personal Information is used by Gett or its affiliates anywhere in the world[1], both actively and passively, when you use a Gett website, (“Site”), and/or download or use the Gett Mobile Telephone Application (“App”), whether you are a driver, fleet, transportation provider, or courier (in each case, a “Driver”), rider, delivery recipient or sender (in each case, a “Rider”), App user, Site visitor, office visitor, or job applicant. With this policy (together with Gett’s Terms & Conditions and any other documents referred to therein) Gett wishes to outline the basis on which any Personal Information Gett collects from you, your representative, or employer, or that you provide to Gett, will be processed including, what information it may collect from you via the Site and/or the App, how it will use it, how it may disclose information provided by you to third-parties and the use of “cookies” or similar files or tags on the Site and by the App.' },
      { type: 'plain', marker: '1.3', value: 'Gett is committed to safeguarding your Personal Information (as defined below) in line with applicable data protection laws. Please read the following carefully to understand Gett’s views and practices regarding your personal data and how Gett will treat it.' }
    ]
  },
  ...
  { type: 'subheader', value: '2. USER’S ACKNOWLEDGEMENT OF THIS POLICY' },
  {
    type: 'list',
    value: [
      { type: 'plain', marker: '2.1', value: 'By using Gett’s services (the “Services”) or registering, downloading information or entering the Site and/or the App you acknowledge that you are or have had the opportunity to become aware of this Privacy Policy and Gett’s practices described therein, including the processing (including collecting, using, disclosing, retaining or disposing) of your information under the terms of this policy. The information Gett holds about you may be held and processed on computer and/or paper files.' },
      { type: 'plain', marker: '2.2', value: 'In the event where you provide Gett with any information regarding another person, you procure that you have made them aware of this privacy policy.' },
      { type: 'plain', marker: '2.3', value: 'If you have any questions or comments regarding privacy issues on the Site and/or the App, please contact Gett by email at privacy@gett.com' }
    ]
  },
  ...
  { type: 'subheader', value: '3. TYPES OF INFORMATION WE COLLECT' },
  {
    type: 'list',
    value: [
      { type: 'plain', marker: '3.1', value: 'Gett collects both “Personal Information” and “Anonymous Information” about our users and visitors. Personal Information is information that can be used to contact or identify you, such as your full name, email address, phone number, payment method details, login name, password, mailing address, IP address, and profile picture, as well as information that is linked to such information. “Anonymous Information” is information that we cannot use to contact or identify you and is not linked to information that can be used to do so. It includes passively collected information about your activities on the Site or on the App, such as usage data, to the extent that information is not linked to your Personal Information.' },
      { type: 'plain', marker: '3.2', value: 'You can access and browse certain portions of the Site and download the App without disclosing Personal Information, although, like most website and mobile app providers, we passively collect certain information from your devices, such as your IP address, screen resolution information, geographic location, Wifi information, browser information, unique device identifier (“UDID”) where applicable and/or your mobile operating system, and use third-parties such as Mixpanel and other SDK’s to obtain detailed analytics on the device. We also collect geolocation data from visitors that download and open the App. Sometimes, this passively collected information will constitute Personal Information – please see Sections 3.1.5 and 3.1.7 in particular. Please note that you can choose not to provide us with certain information (for instance, by adjusting your cookie settings, see Section 5), and it is your voluntary decision whether to provide us with any such information but choosing not to will limit the features of the Site or the App you can access and use.' },
      {
        type: 'list',
        marker: '3.3',
        title: 'Voluntarily submitted information. We collect information that you provide to us during your use of the Site, and/or App. Some examples include:',
        value: [
          { type: 'plain', marker: '3.3.1', value: 'Personal Information that you enter when registering for or using the App, including your full name, email address, phone number, payment method, billing information, profile picture and profile information;' },
          { type: 'plain', marker: '3.3.2', value: 'communications with us (e.g. emails, text messages) or with other Riders or Drivers (e.g. verbal or written instructions to Drivers);' },
          { type: 'plain', marker: '3.3.3', value: 'information you provide in your user preferences or surveys, to customer support services or customer support calls or that you post on any forums or message boards, including social media and blogs. We may record your customer support calls for quality assurance purposes and for improving our services;' },
          { type: 'plain', marker: '3.3.4', value: 'the provision of services or online content to deal with your requests and enquiries. This includes data you provide at the time of: registering to use the Site and/or the App; subscribing to any services or Gett offers; downloading information posted on the Site and/or the App; posting material; or requesting further services from Gett;' },
          { type: 'plain', marker: '3.3.5', value: 'data you provide to us or to a third-party in connection with third-party loyalty schemes with which Gett partners, including loyalty ID or scheme membership number and information about points accrued;' },
          { type: 'plain', marker: '3.3.6', value: 'data you provide, including photos or comments, in connection with or participation in any promotions or competitions sponsored, promoted or offered by Gett and/or any third-party and any data provided to Gett by way of feedback, profile forms or Site/App issues;' },
          { type: 'plain', marker: '3.3.7', value: 'data you provide, including a copy of your identification or credit card, in connection with instances where Gett needs to authenticate user identity and/or ownership of the payment method provided;' },
          { type: 'plain', marker: '3.3.8', value: 'information about you which you provide when corresponding with Gett by email, post, the App, sms, messenger, telephone or otherwise, in which case Gett may keep a record of that correspondence to respond to your enquiries and improve its services;' },
          { type: 'plain', marker: '3.3.9', value: 'where you are a Driver, insurance policies and licensing information; and' },
          { type: 'plain', marker: '3.3.10', value: 'other information from your interaction with the Site and/or the App, services, content and advertising. With regard to each of your visits to the Site and/or use of the App, Gett may automatically collect authentication data, technical information and information about your visit, including computer and connection information, statistics on page views, traffic to and from the Site, ad data, IP address, standard web log information and the resources that you access.' }
        ]
      },
      {
        type: 'list',
        ...
        value: [
          { type: 'plain', marker: '3.4.1', value: 'Geolocation data: If you access the App through a mobile device, we may access, collect, monitor and/or remotely store “geolocation data,” which may include the GPS coordinates of your trip (including pickup and drop-off data and route information) or similar information regarding the location of your mobile device.' },
          { type: 'plain', marker: '3.4.2', value: 'Contacts: We may access your address book, calendar, or contacts if you provide us with your permission to do so.' },
          { type: 'plain', marker: '3.4.3', value: 'Transaction data: We collect information created during your various interactions with the Service, including the date and time of any ride using the Gett Service (a “Ride”), distance of Ride, amount charged, including breakdown of base fee, tip and additional fees, as well as promotional code delivery.' }
        ]
      },
      {
        type: 'list',
        ...
        value: [
          { type: 'plain', marker: '3.5.1', value: 'If you are using our Website, we collect information from you, including your hardware model, browser type, operating system, Internet Protocol (IP) and domain name. If you are using a mobile device, we may also receive your UDID, or another unique identifier, and mobile operating system. We may correlate this information with other Personal Information we have about you. We may also use cookies and URL information to gather information regarding the date and time you used the Service and the information for which you searched and accessed.' },
          { type: 'plain', marker: '3.5.2', value: 'In connection with your use of the App, we may receive your call data, including the date and time of calls and SMS messages with Gett or Drivers, the parties’ phone numbers and the content of those SMS messages.' },
          { type: 'plain', marker: '3.5.3', value: 'We may also use third-party tracking services, such as Google Analytics, and usage logs, to track and analyse data from users of the Service for purposes of security, fraud prevention, and money laundering prevention.' },
          { type: 'plain', marker: '3.5.4', value: 'If you choose to remit payment for a Ride via a third-party payment provider (e.g. Google Wallet), your Personal Information (excluding full payment card information) obtained by the payment provider may be given to us by such payment provider.' },
          { type: 'plain', marker: '3.5.5', value: 'If you choose to login to the App or Site via a third-party social media website (e.g. Facebook), your Personal Information may be provided to us by such social media website.' },
          { type: 'plain', marker: '3.5.6', value: 'Gett may also share your data with its third-party statistical analytics service provider, solely for the provision of analytics and to better understand its users.' },
          { type: 'plain', marker: '3.5.7', value: 'Because we rely on third-party commercial software and programs to operate our servers, we may inadvertently collect Personal Information due to certain automatic functions or features contained in such software or due to certain software changes or upgrades. We will use reasonable efforts to remove any such information after we discover such information in our system. If you know of any such unintended collections, please notify us promptly so we can take the necessary action to remove such information from our system.' }
        ]
      },
      {
        type: 'list',
        ...
        value: [
          ...
          { type: 'plain', value: 'Gett may receive information about you if you use any of the other websites it operates or the other services it provides. Gett also works closely with third parties (including, for example, business partners, subcontractors in technical, payment and delivery services, advertising networks, analytics providers, search information providers, credit reference agencies) and may receive information about you from them. Where third-parties collect information about you and share it with us, you should refer to their separately maintained privacy policies or notices.' }
        ]
      },
      {
        type: 'list',
  ...
  { type: 'subheader', value: '4. COOKIES AND OTHER WEB FILES OR TAGS' },
  {
    ...
    value: [
      ...
      { type: 'plain', marker: '4.4', value: 'The cookies will, among other things, track clicks, and online activity.' },
      {
        type: 'list',
        marker: '4.5',
        title: 'For the same reason, the Site and the App both use cookies and other local files to distinguish you from other users. Gett may use a cookie or configuration file, which is stored on the browser or hard drive of your computer and/or your mobile telephone device, to obtain information about your general internet usage. Cookies and other such files contain information that is transferred to your computer’s and/or mobile telephone device’s hard drive. They help Gett to improve the Site and the App, and to deliver a better and more personalised service. They enable Gett:',
        value: [
          { type: 'plain', marker: '4.5.1', value: 'to estimate Gett’s audience size and usage pattern and perform other analytics;' },
          ...
          { type: 'plain', marker: '4.5.3', value: 'to store information about your preferences and to allow Gett to customise the Site and/or App according to your individual interests and the device or browser you are using;' },
          { type: 'plain', marker: '4.5.4', value: 'to continually improve Gett’s Services;' },
      ...
      { type: 'plain', marker: '4.7', value: 'You may block cookies by activating the setting on your browser that allows you to refuse the setting of all or some cookies. However, if you select a setting that is too restrictive, you may be unable to access certain parts of the Site and/or App. Unless you have adjusted your browser setting so that it will refuse cookies, Gett’s system will issue cookies when you log on to the Site and/or use the App. You may wish to look at http://www.aboutcookies.org/ which has further information on cookies and how to manage them.' },
    ...
    value: [
      {
        type: 'list',
        marker: '6.1',
        title: 'Gett uses information held about you (including both Personal and Anonymous Information) in the following ways:',
        value: [
          ...
          { type: 'plain', marker: '6.1.6', value: 'to provide you with information about products or Services that you receive from Gett (sometimes called “Service Messages”), for example, notices of updates to our Privacy Policy and invoices from Rides;' },
          { type: 'plain', marker: '6.1.7', value: 'to carry out Gett’s obligations arising from any contracts entered between you and Gett (including but not limited to providing you with the information, goods and/or Services you request from it);' },
          { type: 'plain', marker: '6.1.8', value: 'to validate and reimburse valid third-party loyalty coupons for Gett Rides and to notify third-party loyalty partners about qualifying Rides which may accrue third- party loyalty scheme points;' },
          { type: 'plain', marker: '6.1.9', value: 'to provide you with information (by email, sms, messenger, post or telephone) about other goods and Services Gett offers that are similar to those that you have already purchased or enquired about or which may interest you, having first obtained your consent where required to do so (and subject always to your right to opt-out of marketing messages, see section 13.1);' },
          { type: 'plain', marker: '6.1.10', value: 'to provide you with information (by email, sms, messenger, post or telephone) about goods or services offered by Gett’s promotional partners which are relevant to Services you have requested from Gett, or which we otherwise believe may interest you, having first obtained your consent where required to do so (and subject always to your right to opt-out of marketing messages, see section 13.1);' },
          { type: 'plain', marker: '6.1.11', value: 'to allow you to participate in interactive features of Gett’s Services, when you choose to do so;' },
          { type: 'plain', marker: '6.1.12', value: 'to contact you for your views on Gett’s Services and to notify you about changes or developments to Gett’s Service;' },
          ...
          { type: 'plain', marker: '6.1.14', value: 'as part of Gett’s efforts to keep the Site and the App safe and secure and for the prevention of fraud;' },
          { type: 'plain', marker: '6.1.15', value: 'to measure or understand the effectiveness of any advertising Gett serves to you and others, and to deliver relevant advertising to you;' },
          ...
          { type: 'plain', marker: '6.1.18', value: 'to comply with Gett’s legal obligations;' },
          { type: 'plain', marker: '6.1.19', value: 'to protect Gett’s rights and interests.' }
        ]
      },
      { type: 'plain', marker: '6.2', value: 'Gett’s third-party service providers may cross-reference your data with data it already holds (independently of Gett) to provide Gett with statistical analysis of the demographic of its users. Gett uses aggregated and anonymous analytics information for internal business planning and other similar purposes.' },
      {
        type: 'list',
        marker: '6.3',
  ...
  { type: 'subheader', value: '7. SECURITY AND DATA RETENTION' },
  {
    ...
    value: [
      ...
      { type: 'plain', marker: '7.3', value: 'Where Gett has given you (or where you have chosen) a username, login or password which enables you to access certain parts of the Site and/or the App, you are responsible for keeping this information confidential. Gett asks you not to share a username, login or password with anyone.' },
      { type: 'plain', marker: '7.4', value: 'Gett restricts access to your Personal Information to individuals who need access to it in order to process it on Gett’s behalf. These individuals, where employees, are bound by confidentiality agreements and Gett will take appropriate action (which may include disciplinary proceedings) in the event Gett finds that its employee(s) has failed to meet standards in looking after your personal data. Gett cannot accept any liability for employees or agents acting outside its normal course of business, or for Drivers or any third-parties with whom your Personal Information may be shared (as described in section 1.1) who act outside of the terms of our contracts with them.' },
  ...
  { type: 'subheader', value: '8. DISCLOSURE AND SHARING OF YOUR INFORMATION' },
  {
    ...
    value: [
      ...
      },
      {
        ...
        value: [
          { type: 'plain', value: 'We also share Personal Information with vendors, payment providers, transportation providers, promotion companies, sponsorship companies, commercial software providers, consultants, market researchers and data processers who perform services on behalf of Gett, including without limitation, companies that provide route guidance, estimated times of arrival, email services and host the Website, App and Service. We also share Personal Information with third-parties that provide analysis, monitoring, and reports to assist us in preventing and detecting fraudulent transactions and other activity. Gett has selected companies who maintain high standards with respect to privacy and agree to use the Personal Information only to perform specific services on behalf of Gett and in accordance with the terms and conditions of this Privacy Policy.' }
        ]
      },
      {
        type: 'list',
        ...
        value: [
          { type: 'plain', value: 'We may disclose information we have collected about you if required to do so by law or if we, in our sole discretion, believe that disclosure is reasonable to comply with the law, requests or orders from law enforcement, or any legal process (whether or not such disclosure is required by applicable law), or to protect or defend Gett’s, or a third-party’s, rights or property. We may also reserve the right to disclose information we’ve collected about you for purposes of protecting the health and safety of our Riders and Drivers, such as in the case of risk of harm or violence against any person. Finally, we may also disclose information in order to enforce or apply our Terms and Conditions https://gett.com/uk/termsconditions.html and other agreements; or to protect the rights, property, or safety of Gett, its customers, or others. This includes exchanging information with other companies and organisations for the purposes of fraud protection and credit risk reduction.' }
        ]
      },
      {
        type: 'list',
      ...
      },
      {
        ...
        value: [
          { type: 'plain', value: 'As referred to in section 6.1.9, Gett may disclose your information to carefully selected partners which Gett thinks may be of interest to you. These companies may contact you by post, email, telephone or fax for marketing or promotional purposes.' }
        ]
      }
    ]
  },
  ...
  { type: 'subheader', value: '9. LOCATION OF YOUR INFORMATION' },
  {
    type: 'list',
    value: [
      { type: 'plain', marker: '9.1', value: 'Your Personal Information may be disclosed to Gett Group entities and third-parties in jurisdictions including, but not limited to: Belarus, Cyprus, Israel, Ireland, Russia, The Netherlands, United Kingdom, United States of America.' },
      { type: 'plain', marker: '9.2', value: 'Consequently, the data that Gett collects from you may be transferred to, and stored at, a country that is not considered to offer an adequate level of protection under your local laws. It may also be processed by staff operating outside your country who work for Gett or for one of its suppliers, service providers or partner entities. By submitting your Personal Information, you acknowledge, and, where necessary under local laws, agree to, this transfer, storing or processing.' },
      { type: 'plain', marker: '9.3', value: 'Gett will take appropriate steps to ensure that your Personal Information is treated securely and in accordance with applicable Privacy Laws and this Privacy Policy. This may include putting in place data transfer agreements or ensuring that Gett or third-parties comply with data transfer mechanisms or schemes. If you are located in the EU, you have a right to request to obtain further information about the data transfer mechanisms used to transfer your Personal Information to third countries.' }
    ]
  },
  ...
  { type: 'subheader', value: '10. JOB APPLICANTS' },
  {
    type: 'list',
    value: [
      { type: 'plain', value: 'In submitting your application, your Personal Information included in your CV will be used as outlined in our Terms and Conditions for Job Applicants that you will find here. If you do not want your Personal Information to be used, please do not submit your CV.' }
    ]
  },
    ...
    value: [
      {
        ...
        value: [
          ...
          { type: 'plain', marker: '11.1.2', value: 'Accuracy and right of rectification: Gett seeks to ensure that your Personal Data is accurate, complete and kept up-to-date to the extent reasonably necessary for the purposes described herein. If the Personal Information is incorrect, incomplete or not processed in compliance with applicable law or this Policy, you may have the right to have your Personal Information rectified, deleted or blocked (as appropriate) in accordance with applicable law.' },
          { type: 'plain', marker: '11.1.3', value: 'Right to object to or withdraw consent: In certain circumstances (e.g., where your Personal Information is processed on the basis of Gett’s legitimate interests), you may have the right to object to the processing of your Personal Information on the basis of compelling grounds related to your particular situation and in accordance with applicable law. For instance, you may have the right to request that Gett does not process your personal data for marketing purposes. In such a case, you can control your initial marketing preferences by ticking the relevant box situated on the form on which your data is collected (the registration form). Thereafter, you can follow the opt-out links or unsubscribe directions in emails or SMS messages. If the processing of your Personal Information is based on your consent, you may have the right to withdraw your consent to such processing at any time. It is worth noting that the withdrawing of consent has no impact on earlier processing on such basis, and does not prevent Gett from invoking another legal basis for the processing of the relevant Personal Information.' },
      ...
      { type: 'plain', marker: '11.2', value: 'To exercise these rights, where applicable, please contact Gett at privacy@Gett.com or use the appropriate functionality in the App or Site. In this context, Gett asks that you provide it with one form of photographic identification so that Gett can verify your identity.' },
      { type: 'plain', marker: '11.3', value: 'From time to time Gett may post links to third-party websites on the Site and/or the App. These links are provided as a courtesy to Gett’s users and visitors and are not administered or verified in any way by Gett. Such links are accessed by you at your own risk and Gett makes no representations or warranties about the content of such websites including any cookies used by the website operator. If you follow a link to any of these websites, please note that these websites have their own privacy policies and that Gett does not accept any responsibility or liability for these policies. As a result, Gett strongly recommends that you read the privacy policies of any third-party websites before you provide any personal data to them.' }
    ]
  },
  ...
  { type: 'subheader', value: '12. CHILDREN' },
  {
    type: 'list',
    value: [
      { type: 'plain', value: 'Neither the Site nor the App are directed or targeted to children under the age of 18, and Gett does not knowingly collect personally identifiable information from children under the age of 18. Gett requires users under 18 years of age to obtain the consent of a parent or guardian, to view the Site or use the App. If Gett learns that a child under 18 years of age has provided personally identifiable information to the Site, it will use reasonable efforts to remove such information from its files. No part of our Service is directed towards children under the age of 18 and we do not want Personal Information from children under the age of 18. If you believe that a child under 18 years of age has given us Personal Information, please contact Gett at privacy@gett.com.' }
    ]
  },

  { type: 'subheader', value: '13. CHANGES TO GETT’S PRIVACY POLICY' },
  {
    type: 'list',
    value: [
      { type: 'plain', value: 'Gett may change this Privacy Policy from time to time. Any changes Gett may make to this Privacy Policy in the future will be posted on this page and, where Gett deems appropriate, notified to you (usually by email). You are therefore invited to check it each time you send Gett Personal Information. The date of the most recent revisions will appear on this page.' }
    ]
  },
